...
//   const { products } = useGetProductsDateRange({ isActive: true })
//
//   useEffect(() => {
...
//         let delay = 1000
//         console.log('ingresando al feching de planes')
//         while (attempts > 0) {
//           try {
...
//   //       const preguntaId = product.idPregunta
//   //
//   //       if (preguntaId && daysDifference >= minDays && daysDifference <= maxDays) {
//   //         numerosPreguntas.push(preguntaId)
//   //       }
//   //     }
//   //
