      ...
      <div className="space-y-4 p-4">
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor={`age-${traveler.id}`} className="block font-semibold text-gray-500 text-sm mb-1">
                {t('label-age')}
              </label>
              <Input id={`age-${traveler.id}`} name="age" value={traveler.age} disabled className="rounded-3xl border-gray-300 p-6" />
            </div>
            <div>
              <label htmlFor={`gender-${traveler.id}`} className="block font-semibold text-gray-500 text-sm mb-1">
                {t('label-gender')}
              </label>
              <Select
          ...
          <div>
            <label htmlFor={`nationality-${traveler.id}`} className="block font-semibold text-gray-500 text-sm mb-1">
              {t('label-nationality')}
            </label>
            <Select
          ...
          <div>
            <label htmlFor={`residenceCountry-${traveler.id}`} className="block font-semibold text-gray-500 text-sm mb-1">
              {t('label-residence-country')}
            </label>
            <Select
              //id={`residenceCountry-${traveler.id}`}
          ...
          />
          <div>
            <label htmlFor={`email-${traveler.id}`} className="block font-semibold text-gray-500 text-sm mb-1">
              {t('label-email')}
            </label>
            <Input
