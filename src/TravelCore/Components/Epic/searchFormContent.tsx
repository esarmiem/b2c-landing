      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            aria-expanded={open}
            className="justify-start rounded-full overflow-hidden whitespace-nowrap text-ellipsis"
          >
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            className={cn(
              "justify-start text-left font-normal rounded-full overflow-hidden whitespace-nowrap text-ellipsis",
