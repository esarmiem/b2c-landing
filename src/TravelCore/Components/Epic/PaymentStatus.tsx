...
*/
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex flex-col gap-6 items-center justify-center py-8 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          ...
          <div className="flex justify-center pt-4 w-full">
            <div className="text-center space-y-6 w-full">
              ...
              <div className="relative">
                ...
                >
                  <button className="mt-4 px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg hover:from-red-600 hover:to-red-700 focus:outline-none focus:ring-2 focus:ring-red-200 focus:ring-offset-2 flex items-center justify-center space-x-3 w-full transition-all duration-300 shadow-md hover:shadow-lg">
      ...
      {status === "loading" && (
        <div className="flex flex-col items-center justify-center gap-5 bg-gradient-to-r from-gray-700 to-gray-800 rounded-xl shadow-lg p-10 w-full max-w-2xl">
          <div className="animate-pulse flex flex-col items-center">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-white text-center mt-6">
      ...
      {status != "loading" &&
        (status === "Pagado" || status === "Rechazado") &&
        dataSummary && (
              ...
              <div className="flex flex-col items-center justify-center gap-5">
                ...
                >
                  {isApproved ? (
                    ...
                    <CircleX className="w-12 h-12 text-white" />
                  )}
                </div>
                  ...
                  <div className="mt-6 space-y-3 bg-white p-4 rounded-lg border border-gray-100">
                    <div className="grid grid-cols-2 gap-2 items-center">
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-600">
                          {t("label-price-per-person-cop")}
                        </span>
                      </div>
                      <span className="text-end font-medium text-gray-800">
                        ${dataSummary.passengerValueCOP?.toLocaleString() || 0}{" "}
                        COP
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 items-center">
                      <div className="flex items-center">
                        <DollarSign className="w-4 h-4 text-gray-500 mr-1" />
                        <span className="text-gray-600">
                          {t("label-price-per-person-usd")}
                        </span>
                      </div>
                      <span className="text-end font-medium text-gray-800">
                        ${dataSummary.passengerValue || 0} USD
                      </span>
                    </div>
                    <Separator className="my-2" />

                    {/* Mostrar descuentos si existen */}
                    {dataSummary.COPdiscount &&
                      dataSummary.COPdiscount.percentage > 0 && (
                        <>
                          <div className="grid grid-cols-2 gap-2 items-center">
                            <div className="flex items-center">
                              ...
                              <span className="text-gray-600">
                                {t("label-discount")} (
                                {dataSummary.COPdiscount.percentage}%)
                              </span>
                            </div>
                            <span className="text-end font-medium text-green-600">
                              -$
                              {dataSummary.COPdiscount.discountValue?.toLocaleString() ||
                                0}{" "}
                              COP
                            </span>
                          </div>
                    ...
                    {dataSummary.upgrades &&
                      dataSummary.upgrades.length > 0 && (
                        <>
                          <div className="grid grid-cols-2 gap-2 items-center">
                            <div className="flex items-center">
                            ...
                            <span className="text-end font-medium text-gray-800">
                              $
                              {dataSummary.totalUpgrades?.toLocaleString() || 0}{" "}
                              COP
                            </span>
                          </div>
                          <Separator className="my-2" />
                    ...
                    <div className="grid grid-cols-2 gap-2 items-center">
                      <div className="flex items-center">
                        <DollarSign className="w-4 h-4 text-gray-500 mr-1" />
                        <span className="text-gray-600">
                          {t("label-total-price-cop")}
                        </span>
                      </div>
                      <span className="text-end font-medium text-gray-800">
                        ${dataSummary.totalOrderCOP?.toLocaleString() || 0} COP
                      </span>
                    </div>
                    <Separator className="my-2" />
                    ...
                    <div className="grid grid-cols-2 gap-2 items-center">
                      <div className="flex items-center">
                        <DollarSign className="w-4 h-4 text-gray-500 mr-1" />
                        <span className="text-gray-600">
                          {t("label-total-price-usd")}
                        </span>
                      </div>
                      <span className="text-end font-medium text-gray-800">
                        ${dataSummary.totalOrderUSD || 0} USD
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-4 mt-4 border-t border-gray-200">
                      ...
                      <div className="flex items-center justify-end">
                        <span className="font-bold text-lg text-gray-800">
                          ${dataSummary.totalOrderCOP?.toLocaleString() || 0}{" "}
                          COP
                        </span>
                        {!isApproved && (
