...
interface PhoneNumberFormProps {
  ...
  onChange?: (name: string, value: string) => void; // Firma corregida.
}
      ...
      <div>
        ...
        <div className="flex border border-gray-300 rounded-3xl">
          <Select
            ...
            onValueChange={(val) => onChange?.("countryCode", val)} // Firma corregida.
          >
          ...
          <Input
            ...
            value={value.phone}
            onChange={(e) => onChange?.("phone", e.target.value)} // Firma corregida.
          />
        </div>
      </div>
    );
