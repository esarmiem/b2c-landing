...
export const FilterForm: FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <div className={`bg-white rounded-lg flex flex-col md:flex-row items-end justify-between p-4 gap-4 flex-wrap transition-all ${
        isEditing ? "border-2 border-red-500" : ""
        }`}>
        {/* Origen */}
        <div className="flex items-end gap-2 w-full sm:w-1/2 md:w-auto">
          ...
          <div className="leading-4 space-y-0.5">
            ...
            <div className="actionable text-sm mt-0">Colombia</div>
          </div>
          ...
          <div className="leading-4 space-y-0.5">
            ...
            <div className="actionable text-sm mt-0">Destino</div>
          </div>
        </div>
        ...
        <div className="flex items-end gap-2 w-full sm:w-1/2 md:w-auto">
          ...
          <div className="leading-4">
            ...
            <div className="actionable text-sm mt-0">30/01/2025</div>
          </div>
          <div className="text-black">
          ...
          <div className="leading-4 space-y-0.5">
            ...
            <div className="actionable text-sm mt-0">06/02/2025</div>
          </div>
        </div>
        ...
        <div className="flex items-end gap-2 w-full sm:w-1/2 md:w-auto">
          ...
          <div className="leading-4">
            ...
            <div className="actionable text-sm mt-0">2 Pasajeros</div>
          </div>
        </div>
