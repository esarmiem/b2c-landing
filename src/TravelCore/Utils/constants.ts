 ...
 *
 * Spanish:
 * Define la URL base para la API, obtenida de la variable de entorno VITE_REACT_APP_API_URL.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de autenticación, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_AUTHENTICATION.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de países, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_CONTRIES.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de llegadas, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_ARRIVALS.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de preguntas, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_QUESTIONS.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de condiciones médicas, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_MEDICAL_CONDITIONS.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de tipos de documento, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_DOCUMENT_TYPE.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de productos, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_PRODUCTS.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de parámetros, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_PARAMETERS.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio que obtiene ciudades por país, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_GET_CITIES_BY_COUNTRY.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio que obtiene el precio de la orden basado en la edad, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_GET_ORDER_PRICE_EDAD.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio que verifica preórdenes ISL, obtenido de la variable de entorno VITE_REACT_APP_SERVICE_CHECK_PREORDER_ISL.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el nombre de usuario para la autenticación, obtenido de la variable de entorno VITE_REACT_APP_USER_NAME.
 *
 * English:
 ...
 *
 * Spanish:
 * Define la contraseña del usuario para la autenticación, obtenido de la variable de entorno VITE_REACT_APP_USER_PASSWORD.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el nombre de usuario para el servicio ISL, obtenido de la variable de entorno VITE_ISL_USER_NAME.
 *
 * English:
 ...
 *
 * Spanish:
 * Define la contraseña para el servicio ISL, obtenido de la variable de entorno VITE_ISL_PASSWORD.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de actualizaciones de productos en ISL, obtenido de la variable de entorno VITE_ISL_APP_SERVICE_UPGRADES.
 *
 * English:
 ...
 *
 * Spanish:
 * Define el endpoint para el servicio de autenticación ISL, obtenido de la variable de entorno VITE_REACT_APP_API_URL_ISL.
 *
 * English:
